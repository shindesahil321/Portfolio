...
export const projectsData = [
  {
    title: "Mern-github-app-master",
    description:
      "Built a full-stack MERN GitHub App with API integrations and responsive React.js design for seamless user experiences.",
    tags: ["ReactJS", "JWT", "Typescript", "MERN", "API"],
    imageUrl: corpcommentImg,
    linkToProject: "https://mern-github-app-master-1.onrender.com/",
  },
  {
    title: "Calendar",
    description:
      "Calendar app using React.js that allows users to add events and change the background image.",
    tags: ["React", "Tailwind CSS", "MERN"],
    imageUrl: Chat,
    linkToProject: "https://calendar-app-5fpg-git-master-shindesahil321s-projects.vercel.app/",
  },
  {
    title: "Food-Delivery",
    description:
      "A food delivery platform built with the MERN stack, offering a seamless ordering experience and a smooth, user-friendly interface.",
    tags: ["ReactJS", "CSS", "Node.js","Express", "MongoDB"],
    imageUrl: wearhouse,
    linkToProject: "https://food-delivery-rjtf.vercel.app/",
  },
  {
    title: "MongoHub",
    description:
